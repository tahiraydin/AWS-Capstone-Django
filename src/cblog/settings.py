...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/taydin/capstone/username')
    password_param = ssm.get_parameter(Name="/taydin/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone.cvuwxlzcijmf.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'taydincapstonesstatic' # please enter your s3 bucket name
